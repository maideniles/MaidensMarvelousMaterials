...
public class JacarandaTrunkVineDecorator extends TreeDecorator {
    public static final Codec<JacarandaTrunkVineDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(JacarandaTrunkVineDecorator::new, (p_69989_) -> {
        return p_69989_.probability;
    }).codec();
    private final float probability;

    public JacarandaTrunkVineDecorator(float p_69976_) {
    ...
    public void placeVine(BlockPos pos, BooleanProperty property, TreeDecorator.Context context) {
        context.setBlock(pos, ModBlocks.JACARANDA_VINE.get().defaultBlockState().setValue(property, true));
    }
        ...
        context.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos)) {
                    this.placeVine(blockpos, JacarandaVineBlock.EAST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos1)) {
                    this.placeVine(blockpos1, JacarandaVineBlock.WEST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos2)) {
                    this.placeVine(blockpos2, JacarandaVineBlock.SOUTH,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos3)) {
                    this.placeVine(blockpos3, JacarandaVineBlock.NORTH,context);
                }
            }
