...
public class LaburnumTrunkVineDecorator extends TreeDecorator {
    public static final Codec<LaburnumTrunkVineDecorator> CODEC = Codec.unit(() -> {
        return LaburnumTrunkVineDecorator.INSTANCE;
    });
        ...
        p_226077_.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos)) {
                    p_226077_.placeVine(blockpos, LaburnumVineBlock.EAST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos1)) {
                    p_226077_.placeVine(blockpos1, LaburnumVineBlock.WEST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos2)) {
                    p_226077_.placeVine(blockpos2, LaburnumVineBlock.SOUTH);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos3)) {
                    p_226077_.placeVine(blockpos3, LaburnumVineBlock.NORTH);
                }
            }
