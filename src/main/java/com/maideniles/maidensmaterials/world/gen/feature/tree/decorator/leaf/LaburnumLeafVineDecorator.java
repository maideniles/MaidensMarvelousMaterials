        ...
        p_226039_.leaves().forEach((p_226035_) -> {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos)) {
                    addHangingVine(blockpos, LaburnumVineBlock.EAST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos1)) {
                    addHangingVine(blockpos1, LaburnumVineBlock.WEST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos2)) {
                    addHangingVine(blockpos2, LaburnumVineBlock.SOUTH, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos3)) {
                    addHangingVine(blockpos3, LaburnumVineBlock.NORTH, p_226039_);
                }
            }
