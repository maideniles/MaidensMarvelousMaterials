        ...
        p_226039_.leaves().forEach((p_226035_) -> {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos)) {
                    addHangingVine(blockpos, SilverbellVineBlock.EAST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos1)) {
                    addHangingVine(blockpos1, SilverbellVineBlock.WEST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos2)) {
                    addHangingVine(blockpos2, SilverbellVineBlock.SOUTH, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos3)) {
                    addHangingVine(blockpos3, SilverbellVineBlock.NORTH, p_226039_);
                }
            }
