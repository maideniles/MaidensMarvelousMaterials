...
public class JadeLeafVineDecorator extends TreeDecorator {
        ...
        context.leaves().forEach((p_226035_) -> {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (context.isAir(blockpos)) {
                    addHangingVine(blockpos, JadeVineBlock.EAST, context);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (context.isAir(blockpos1)) {
                    addHangingVine(blockpos1, JadeVineBlock.WEST, context);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (context.isAir(blockpos2)) {
                    addHangingVine(blockpos2, JadeVineBlock.SOUTH, context);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (context.isAir(blockpos3)) {
                    addHangingVine(blockpos3, JadeVineBlock.NORTH, context);
                }
            }
    ...
    private static void addHangingVine(BlockPos blockPos, BooleanProperty p_226042_, Context p_226043_) {
        p_226043_.setBlock(blockPos, ModBlocks.JADE_VINE.get().defaultBlockState().setValue(p_226042_, true));
        int i = 4;

        for(BlockPos blockpos1 = blockPos.below(); p_226043_.isAir(blockpos1) && i > 0; --i) {
            p_226043_.setBlock(blockpos1, ModBlocks.JADE_VINE.get().defaultBlockState().setValue(p_226042_, true));
