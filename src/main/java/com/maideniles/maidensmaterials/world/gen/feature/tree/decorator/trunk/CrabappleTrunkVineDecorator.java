...
public class CrabappleTrunkVineDecorator extends TreeDecorator {
    public static final Codec<CrabappleTrunkVineDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(CrabappleTrunkVineDecorator::new, (p_69989_) -> {
        return p_69989_.probability;
    }).codec();
    private final float probability;

    public CrabappleTrunkVineDecorator(float p_69976_) {
    ...
    public void placeVine(BlockPos pos, BooleanProperty property, TreeDecorator.Context context) {
        context.setBlock(pos, ModBlocks.CRABAPPLE_VINE.get().defaultBlockState().setValue(property, true));
    }
        ...
        context.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos)) {
                    this.placeVine(blockpos, CrabappleVineBlock.EAST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos1)) {
                    this.placeVine(blockpos1, CrabappleVineBlock.WEST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos2)) {
                    this.placeVine(blockpos2, CrabappleVineBlock.SOUTH,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos3)) {
                    this.placeVine(blockpos3, CrabappleVineBlock.NORTH,context);
                }
            }
