        ...
        p_226039_.leaves().forEach((p_226035_) -> {
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos)) {
                    addHangingVine(blockpos, JacarandaVineBlock.EAST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos1)) {
                    addHangingVine(blockpos1, JacarandaVineBlock.WEST, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos2)) {
                    addHangingVine(blockpos2, JacarandaVineBlock.SOUTH, p_226039_);
                }
            }
            ...
            if (randomsource.nextFloat() < this.probability) {
                ...
                if (p_226039_.isAir(blockpos3)) {
                    addHangingVine(blockpos3, JacarandaVineBlock.NORTH, p_226039_);
                }
            }
