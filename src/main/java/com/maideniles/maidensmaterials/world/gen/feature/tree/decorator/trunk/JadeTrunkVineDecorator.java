...
public class JadeTrunkVineDecorator extends TreeDecorator {
    public static final Codec<JadeTrunkVineDecorator> CODEC = Codec.unit(() -> {
        return JadeTrunkVineDecorator.INSTANCE;
    });
        ...
        p_226077_.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos)) {
                    p_226077_.placeVine(blockpos, JadeVineBlock.EAST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos1)) {
                    p_226077_.placeVine(blockpos1, JadeVineBlock.WEST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos2)) {
                    p_226077_.placeVine(blockpos2, JadeVineBlock.SOUTH);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos3)) {
                    p_226077_.placeVine(blockpos3, JadeVineBlock.NORTH);
                }
            }
