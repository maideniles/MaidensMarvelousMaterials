...
public class PoincianaTrunkVineDecorator extends TreeDecorator {
    public static final Codec<PoincianaTrunkVineDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(PoincianaTrunkVineDecorator::new, (p_69989_) -> {
        return p_69989_.probability;
    }).codec();
    private final float probability;

    public PoincianaTrunkVineDecorator(float p_69976_) {
    ...
    public void placeVine(BlockPos pos, BooleanProperty property, Context context) {
        context.setBlock(pos, ModBlocks.POINCIANA_VINE.get().defaultBlockState().setValue(property, true));
    }
        ...
        context.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos)) {
                    this.placeVine(blockpos, PoincianaVineBlock.EAST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos1)) {
                    this.placeVine(blockpos1, PoincianaVineBlock.WEST,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos2)) {
                    this.placeVine(blockpos2, PoincianaVineBlock.SOUTH,context);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (context.isAir(blockpos3)) {
                    this.placeVine(blockpos3, PoincianaVineBlock.NORTH,context);
                }
            }
