...
public class PoincianaTrunkVineDecorator extends TreeDecorator {
    public static final Codec<PoincianaTrunkVineDecorator> CODEC = Codec.unit(() -> {
        return PoincianaTrunkVineDecorator.INSTANCE;
    });
        ...
        p_226077_.logs().forEach((p_226075_) -> {
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos)) {
                    p_226077_.placeVine(blockpos, PoincianaVineBlock.EAST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos1)) {
                    p_226077_.placeVine(blockpos1, PoincianaVineBlock.WEST);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos2)) {
                    p_226077_.placeVine(blockpos2, PoincianaVineBlock.SOUTH);
                }
            }
            ...
            if (randomsource.nextInt(3) > 0) {
                ...
                if (p_226077_.isAir(blockpos3)) {
                    p_226077_.placeVine(blockpos3, PoincianaVineBlock.NORTH);
                }
            }
