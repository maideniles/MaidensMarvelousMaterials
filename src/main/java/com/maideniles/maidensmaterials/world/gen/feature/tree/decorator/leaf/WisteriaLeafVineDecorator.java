...
public class WisteriaLeafVineDecorator extends TreeDecorator {
    public static final Codec<WisteriaLeafVineDecorator> CODEC = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(WisteriaLeafVineDecorator::new, (p_226037_) -> {
    ...
    public WisteriaLeafVineDecorator(float p_226031_) {
