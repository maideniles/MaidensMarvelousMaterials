...
public class ModBlockLootTables extends BlockLoot {
    ...
    //WOOD CRAFTABLES//
        ...
        this.add(ModBlocks.CRABAPPLE_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.POINCIANA_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.LABURNUM_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.JADE_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.PAULOWNIA_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.WISTERIA_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.JACARANDA_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.DOGWOOD_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.SILVERBELL_SLAB.get(),BlockLoot::createSlabItemTable);
        this.add(ModBlocks.CEDAR_SLAB.get(),BlockLoot::createSlabItemTable);
        ...
        this.add(ModBlocks.CRABAPPLE_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.SILVERBELL_DOOR_1.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.CEDAR_DOOR_1.get(),BlockLoot::createDoorTable);

        this.add(ModBlocks.CRABAPPLE_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.SILVERBELL_DOOR_2.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.CEDAR_DOOR_2.get(),BlockLoot::createDoorTable);

        this.add(ModBlocks.CRABAPPLE_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.SILVERBELL_DOOR_3.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.CEDAR_DOOR_3.get(),BlockLoot::createDoorTable);

        this.add(ModBlocks.CRABAPPLE_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.SILVERBELL_DOOR_4.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.CEDAR_DOOR_4.get(),BlockLoot::createDoorTable);

        this.add(ModBlocks.CRABAPPLE_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.SILVERBELL_DOOR_5.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.CEDAR_DOOR_5.get(),BlockLoot::createDoorTable);

        this.add(ModBlocks.CRABAPPLE_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.POINCIANA_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.LABURNUM_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JADE_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.PAULOWNIA_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.WISTERIA_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.JACARANDA_DOOR_6.get(),BlockLoot::createDoorTable);
        this.add(ModBlocks.DOGWOOD_DOOR_6.get(),BlockLoot::createDoorTable);
        ...
        this.dropSelf(ModBlocks.BROWN_STAINED_STAIRS.get());
            //SLABS//
        this.add(ModBlocks.WHITEWASHED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.RED_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.ORANGE_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.YELLOW_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.LIME_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.GREEN_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.CYAN_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.BLUE_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.PURPLE_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.MAGENTA_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.PINK_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.WHITE_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.GRAY_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.BLACK_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
        this.add(ModBlocks.BROWN_STAINED_SLAB.get(), BlockLoot::createSlabItemTable);
            //FENCES//
        ...
        this.dropSelf(ModBlocks.BROWN_STAINED_BUTTON.get());
                //DOORS//
        this.add(ModBlocks.RED_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_1.get(), BlockLoot::createDoorTable);

        this.add(ModBlocks.RED_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_2.get(), BlockLoot::createDoorTable);

        this.add(ModBlocks.RED_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_3.get(), BlockLoot::createDoorTable);

        this.add(ModBlocks.RED_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_4.get(), BlockLoot::createDoorTable);

        this.add(ModBlocks.RED_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_5.get(), BlockLoot::createDoorTable);

        this.add(ModBlocks.RED_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.ORANGE_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.YELLOW_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIME_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GREEN_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.CYAN_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_BLUE_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLUE_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PURPLE_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.MAGENTA_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.PINK_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.WHITE_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.LIGHT_GRAY_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.GRAY_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BLACK_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
        this.add(ModBlocks.BROWN_STAINED_DOOR_6.get(), BlockLoot::createDoorTable);
                //TRAPDOORS//
