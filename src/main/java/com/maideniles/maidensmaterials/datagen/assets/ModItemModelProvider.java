...
public class ModItemModelProvider extends ItemModelProvider {
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, MarvelousMaterials.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
     ...
     withExistingParent(ModBlocks.ACACIA_CHEST.getId().toString(), "chest_inventory").texture("chest_tex", prefix("block/acacia_chest"));
 /*    withExistingParent(ModBlocks.BIRCH_CHEST.getId().toString(), "item/chest").texture("particle", prefix("block/birch_planks"));
     ...
     withExistingParent(ModBlocks.MANGROVE_CHEST.getId().toString(), "item/chest").texture("particle", prefix("block/mangrove_planks"));
...
*/
     ...
     // basicItem(ModItems.MARVELOUS_MANUAL.get());
       ...
       basicItem(ModItems.PRUNING_SHEARS.get());
