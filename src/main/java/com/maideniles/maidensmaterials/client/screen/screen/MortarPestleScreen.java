package com.maideniles.maidensmaterials.client.screen.screen;
...
public class MortarPestleScreen extends AbstractContainerScreen<MortarPestleMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MarvelousMaterials.MOD_ID, "textures/gui/mortar_pestle_gui.png");
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(menu.isCrafting()) {
            blit(pPoseStack, x + 19, y + 12, 176, 11, 32, menu.getScaledProgress());
        }
