package com.maideniles.maidensmaterials.client.screen.menu;


import com.maideniles.maidensmaterials.blockentity.MortarPestleBlockEntity;
import com.maideniles.maidensmaterials.client.screen.screen.ModResultSlot;
...
public class MortarPestleMenu extends AbstractContainerMenu {
    private final MortarPestleBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    private MortarPestleRecipe selectedRecipe;
    ...
    public MortarPestleMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            ...
            this.addSlot(new SlotItemHandler(handler, 1, 126, 15));
            this.addSlot(new SlotItemHandler(handler, 2, 126, 33));
            this.addSlot(new SlotItemHandler(handler, 3, 126, 51));
            this.addSlot(new ModResultSlot(handler, 0, 27, 25));
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.MORTAR_PESTLE.get());
    }
